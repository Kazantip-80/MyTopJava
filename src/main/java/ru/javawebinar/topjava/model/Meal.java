...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BY_BETWEEN,query = "SELECT m FROM Meal m WHERE m.user.id=?1  AND m.dateTime>=?2 AND m.dateTime<=?3 ORDER BY m.dateTime DESC")
})
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BY_BETWEEN = "Meal.getByBetween";
